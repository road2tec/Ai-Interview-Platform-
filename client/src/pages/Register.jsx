    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] flex justify-center items-center py-20 relative overflow-hidden bg-gray-50">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute top-20 right-20 w-[30rem] h-[30rem] bg-indigo-200 rounded-full mix-blend-multiply filter blur-[100px] opacity-40 animate-blob"></div>
                <div className="absolute bottom-20 left-20 w-[25rem] h-[25rem] bg-pink-200 rounded-full mix-blend-multiply filter blur-[100px] opacity-40 animate-blob [animation-delay:2s]"></div>
            </div>
            ...
            <div className="relative z-10 w-full max-w-md animate-slide-up">
                <div className="text-center mb-8">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/70 backdrop-blur-md text-primary-700 text-xs font-bold tracking-widest uppercase mb-4 shadow-sm border border-white/50">
                        <Sparkles className="w-3 h-3 text-purple-500" /> Start Free
                    </div>
                    <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight">Create account</h2>
                    <p className="mt-2 text-gray-500">Master interviews in minutes.</p>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-xl p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-white">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full flex items-center justify-center bg-gradient-to-r from-primary-600 to-indigo-600 text-white font-bold py-4 rounded-full hover:shadow-[0_10px_30px_rgba(99,102,241,0.3)] hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-70 disabled:transform-none disabled:cursor-not-allowed group mt-4 relative overflow-hidden"
                        >
